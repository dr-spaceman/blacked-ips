...
export function Scripts() {
  ...
  const javascript =
    ...
    '\tconst YOUR_API_URL = "https://server-nal4t3.bunnyenv.com/v1/cs/' +
    user.id +
    '/" + visitorId;\n' +
    "\tfetch(YOUR_API_URL)\n" +
    "\t.then(async response => {\n" +
    ...
    <>
      <div className="mb-8 rounded-lg bg-white px-4 py-3 shadow-md dark:bg-gray-800">
        <CardBody className="text-left">
          <span>
            Place the following script inside {"<head> ... </head>"} of the
            html, replace window.ocation.href with disabled page you'd like to
            disable
          </span>
